                    ...
                    <?php while($row=mysqli_fetch_array($result)){
                        ...
                        <th class="text-center"><?php echo $row['category_name']?></th>
                           ...
                           <td class="text-center">
                                      ...
                                      <!--<span class="glyphicon glyphicon-trash"></span> <input type=submit class='btn btn-danger' name=delete value=delete>
                                         <input type=hidden name =id value="<?php echo $row['category_id'];?>" >-->
                                        <a href="delete_category.php?id=<?php echo $row['category_id']; ?>"><span class="glyphicon glyphicon-trash"></span> Delete</a>
                        </td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal col-sm-12">
          ...
          <div class="form-group"><label>Category Id </label><textarea class="form-control" rows="1" placeholder="Id Should be Unique.." data-placement="top" data-trigger="manual"></textarea></div>
          
          <div class="form-group"><label>Category Name</label><textarea class="form-control" rows="4" placeholder="Discription.." data-placement="top" data-trigger="manual"></textarea></div>
